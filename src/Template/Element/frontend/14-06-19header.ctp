            ...
            <div class="col-md-4">
                <div class="logo">
                    ...
                    if (@$this->request->session()->read('Auth.User.id')) {
                        if (@$this->request->session()->read('PALL') == '100') {
                            ?>
                            <a href="<?= HTTP_ROOT . 'calendar-sechedule'; ?>"> 
                            <?php } else { ?>
                                <a href="<?= HTTP_ROOT . 'welcome/style/' . @$profilePending; ?>">    
                                <?php } ?>
                            <?php } else { ?>
                                <a href="<?= HTTP_ROOT; ?>"> 
                                <?php } ?>
                                    ...
                                    submitHandler: function () {
                                        ...
                                        $.post('<?= HTTP_ROOT; ?>' + '/users/ajaxforget', formData, function (response) {
                                            if (response.status == "successs") {
                                                ...
                                                $('#for_submit').hide();
                                                $('#for_submitOk').show();
                                                $('.sign-up-page').append('<div class="alert alert-success" id="forgot-success-msg">' + response.msg + '</div>');
