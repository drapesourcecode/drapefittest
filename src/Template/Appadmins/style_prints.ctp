            ...
            <div style="float: left; width: 95%; margin-bottom: 0; padding: 25px 0 30px; border-bottom: 1px solid #d2d6de; text-align: left;">
                ...
                <ul style="float: left; width:100%; margin:0; padding: 0; list-style-type: none;">
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('1', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('2', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('3', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('4', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('5', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('6', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('7', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('8', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('9', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('10', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('11', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('12', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('13', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('14', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('15', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('16', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('17', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('18', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('19', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
                    ...
                    <li style=" float: left; width: 19%;margin-right: 7px;margin-top: 8px; margin-bottom: 8px;">
                        <div style=" float: left; width: 100%; <?php if (isset($style_sphere_selections->style_sphere_selections_v5) && in_array('20', explode(',', $style_sphere_selections->style_sphere_selections_v5))) { ?> border: 2px solid #ff6c00; <?php }else{ ?> border: 1px solid #ccc; <?php } ?> text-align: center; position: relative; padding: 3px 3px 0; box-sizing: border-box;">
