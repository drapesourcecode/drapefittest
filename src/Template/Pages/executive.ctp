...
<div class="officer-list-box">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 cl-lg-12 col-md-12">
                <ul>
                    <li>
                        <div class="img-box">
                    ...
                    <li>
                        ...
                        <p style="font-size: 18px;color:orange;font-weight: bold;font-style: italic;font-family:Comic Sans MS,cursive;">
                            "I co-founded DrapeFit as a way for women just like me to embrace their individuality. It grew out of a personal need and now, Drape Fit is a place where everyone can explore all the incredible things that style can really do."</p>
                        <h4>Monomita Chakraborty"</h4>
                        <p>CIO & CO-FOUNDER</p>
                        </div>
                    </li>
