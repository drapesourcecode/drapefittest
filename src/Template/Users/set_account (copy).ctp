                        ...
                        <div class="tab-content">
                            <ul id="customers">
                                ...
                                <li>
                                    ...
                                    <span>»</span>
                                    <span>FJJJGJFJG,JFKJGK,JFKDAJ</span>
                                </li>
                                <li>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="one">
                                ...
                                <ul>
                                    <li>
                                        <label>Name</label>
                                        <input type="text" disabled="disable" placeholder="<?php echo $this->request->session()->read('Auth.User.name'); ?>" />
                                    </li>
                                    <li>
                                        <label>Email</label>
                                        <input type="email" disabled="disable" placeholder="<?php echo $this->request->session()->read('Auth.User.email'); ?>" />
                                    </li>
                                    <li>
                                        <label>Password</label>
                                        <input type="password" disabled="disable" placeholder="********" />
                                    </li>
                                </ul>
                                <div class="tab-button">
                                    <button class="btn-boxes" type="button" onClick="location.href = location.href">Cancel</button>
                                    <button class="btn-boxes" type="button">Edit</button>
