                        ...
                        <div class=" tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade active in satya" >
                                ...
                                <div class="checkbox-sitting">
                                    <input onclick="getCheckBox()" id="try_new_items_with_scheduled_fixes12" value="1" name="try_new_items_with_scheduled_fixes" type="checkbox" <?php if (@$LetsPlanYourFirstFixData->try_new_items_with_scheduled_fixes == 1) { ?> checked <?php } else if (@$LetsPlanYourFirstFixData->try_new_items_with_scheduled_fixes == '') { ?> checked <?php } ?>>
                        ...
                        <div class=" tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade active in satya">
                                ...
                                <?php if (@$LetsPlanYourFirstFixData->try_new_items_with_scheduled_fixes == 1) { ?>
                                    ...
                                    <p>Until you cancel your fit schedule we will charge a styling fee $19 and that will be credit towards any product you buy.</p>
                                </div>
                                <div class="tab-button">
                                    <button name="first_time_fix" value ='first_time_fix' class="btn-boxes" type="Submit">Continue </button>
                                </div>            
                                            ...
                                            <div class="col-sm-12 col-lg-12 col-md-12">
                                                ...
                                                <div class="col-sm-4 col-lg-4 col-md-4">
                                                    ...
                                                    <div class="switch-field">                                                   
                                                        ...
                                                        <input type="radio" id="shirt2" name="loafer_slip" value="2" <?= @$MenStyle->loafer_slip == 2 ? "checked" : ""; ?>>
                                                        <label for="shirt2">Maybe</label>
                                                        <input type="radio" id="shirt3" name="loafer_slip" value="3" <?= @$MenStyle->loafer_slip == 3 ? "checked" : ""; ?>>
                            ...
                            <div class="tab-content tabs data-filup ">
                                <div role="tabpanel" class="tab-pane fade in <?php if ($sections == 'section1') { ?> active <?php } else if ($sections == '') { ?> active <?php } ?> " id="Section1">
                                    ...
                                    <div class="form-box-data checkboxes">
                                        <div class="row">
                                            <div class="col-sm-12 col-lg-12 col-md-12">
                                                <h3>What are your main reasons for signing your child up for Drapefit Fix?</h3>
                                                <h6>Select all that apply.</h6>
                                                <div class="select-boxes">
                                                    <ul>
                                                        <li>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-lg-12 col-md-12">
                                                ...
                                                <label for="body_shape1" class="input-control radio">
                                                    <input id="body_shape1" name="body_shape" value="Slim" type="radio" <?php if (@$KidsSizeFit->body_shape == 'Slim') { ?> checked="checked" <?php } ?>>
                            ...
                            <div class="tab-content tabs data-filup ">
                                ...
                                <div role="tabpanel" class="tab-pane fade  <?php if ($sections == 'section5') { ?>  active in <?php } ?>" id="Section5">
                                    ...
                                    <div class="form-box-data checkboxes">
                                        <div class="row">
                                            <div class="col-sm-12 col-lg-12 col-md-12">
                                                <h3>What are your primary objectives of signing up for Drepefit Fix? </h3>
                                                <h6>Select all that apply.</h6>
                                                <div class="select-boxes">
                                                    <ul>
                                                        <li>
                                    ...
                                    <div class="form-box-data">
                                        ...
                                        <textarea name="final_thoughts" id="final_thoughts" class="form-control" id="exampleTextarea" rows="3" style="padding: 5px 12px 6px; width: 100%; border-color: #C0BDBA;font-size: 18px; line-height: 1.4;min-height: 150px;border-radius: 0px;-webkit-appearance: none;"><?php echo @$Womeninfo->final_thoughts; ?></textarea>
                                    </div>
                                    <div class="col-sm-6 col-lg-6 col-md-6 button-box">
